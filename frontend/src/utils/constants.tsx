...
export const REGEX_NAME = /^([a-zA-Z]{2,30})$/;
export const REGEX_COMPANY_NAME = /^([a-zA-Z0-9 ]{3,40})$/;
export const REGEX_COMPANY_SITE_URL = /^https?:\/\/(?:www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b(?:[-a-zA-Z0-9()@:%_+.~#?&/=]*)$/;
